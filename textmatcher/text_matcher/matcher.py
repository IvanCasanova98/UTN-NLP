...
class Matcher():
    ...
    def getMatch(self, match, context=0):
    ...
    def extend_matches(self, cutoff=0.6):
        extended = False
    ...
    def match(self):
        ...
        for num, match in enumerate(self.extended_matches):
            ...
            phrasesA.append(out.split("\nTest: ")[0])
            phrasesB.append(out.split("\nTest: ")[1])


        return self.numMatches, self.locationsA, self.locationsB,phrasesA,phrasesB
